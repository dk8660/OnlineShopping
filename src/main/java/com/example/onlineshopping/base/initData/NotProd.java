...
public class NotProd {
    @Bean
    CommandLineRunner initData(MemberService memberService, ProductService productService, CartService cartService)  {
        return args -> {
            ...
            cartService.tryAddItem(2, 1, 2);
            cartService.tryAddItem(2, 2, 1);
            cartService.tryAddItem(2, 3, 3);
            cartService.tryAddItem(2, 2, 5);
